 ...
 * subscribe! no password! Only one course!
...
As an example, we create an AR(1) process with $\phi_1=0.85$ and $e$
drawn from the standard normal distribution (mean 0, variance 1).

```{r}
y = rep(NA_real_, 1000) # initialise the variable: not needed, but good practice
y[1] = 0
for (i in 2:1000) y[i] = 0.85 * y[i-1] + rnorm(1)
