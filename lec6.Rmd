...
{\em realistic} scenario. We can estimate it from the data, taking into
...
* given two measurements $z(s_1)$ and $z(s_2)$, we can {\em never}
...
The function $C(h)$ is the {\color{red} covariogram} of the random
function $Z(s)$
...
$\gamma(h)$ is the {\color{red} semivariogram} of $Z(s)$.
...
* subject to debate: it involves {\em modelling}
* synonymous to {\em semivariogram}, but
* semivariance is {\em not} synonymous to variance
