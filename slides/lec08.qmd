...
-   three observation locations: (1,1), (2,1) and (3,1)\* with attribute values (variable to be interpolated) 3,2 and 5
...
-   when using block kriging variance decreases because variability cancels out
