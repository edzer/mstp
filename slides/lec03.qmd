...
We see that <span style="color:blue;">$f(c)$</span> is smaller than $f(d)$, so the minimum must be located between <span style="color:red;">$a$</span>  and <span style="color:red;">$d$</span>. 
